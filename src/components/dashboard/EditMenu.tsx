        ...
        <DialogContent className="max-w-[95vw] w-full mx-auto sm:max-w-xl rounded-lg">
          <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6">
            ...
            <DialogDescription className="text-sm">
              Укажите название и описание категории прямо в CSV (столбцы «категория» и «описание категории»). Можно добавить ссылку на изображение блюда в столбце «фото» — если его не будет, мы установим стандартное.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <p className="text-xs text-gray-500">
                В файле должны быть колонки «категория», «описание категории», «название», «цена» и остальные поля блюда. Дополнительно можно указать ссылку в колонке «фото».
              </p>
            </div>
